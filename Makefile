...
MINICC_SRCS      := $(SCANNER_SRC) $(AST_SRC) $(ERROR_SRC) $(PARSER_SRC) $(ARENA_SRC) \
                     $(HASHTABLE_SRC) $(SYMTAB_SRC) $(AST2SYM_SRC) $(DCE_SRC) $(CP_SRC) $(SEMANTIC_SRC) $(OPTIMIZE_SRC) $(IR_SRC) $(SVN_SRC) parser/main.c
...
TEST_IR_SRCS      := $(SCANNER_SRC) $(DCE_SRC) $(AST_SRC) $(ERROR_SRC) $(PARSER_SRC) $(ARENA_SRC) \
                       $(HASHTABLE_SRC) $(SYMTAB_SRC) $(AST2SYM_SRC) $(SEMANTIC_SRC) $(IR_SRC) $(SVN_SRC) $(DCE_SRC) $(CP_SRC) \
                       tests/test_ir.c
