 ...
 * ---------------------
 *  Parser struct            - Encapsulates parsing state (tokens, arenas).
 *  advance                  - Consumes one token and updates parser state.
 *  match                    - Checks expected token and advances, or reports error.
 ...
 *  parse_function_declaration - Parses a function declaration with parameters and body.
 *  parse_parameter_list     - Parses function parameter list.
 *  parse_if_statement       - Parses if-else statement.
 *  parse_while_statement    - Parses while loop.
